...
/** MangaRecommendation */
export interface MangaRecommendationSchema {
  /** @format uuid */
  id: string;
...
export interface MangaRecommendationListSchema {
  /** @default "ok" */
  result: string;
  /** @default "collection" */
  response: string;
  data: MangaRecommendationSchema[];
  limit: number;
  offset: number;
  total: number;
}
 ...
 */
export type ReferenceExpansionMangaRecommendationSchema = "manga"[];
...
export interface GetMangaRecommendationParamsSchema {
  /** Reference expansion options */
  includes: ReferenceExpansionMangaRecommendationSchema;
  /** @default {"score":"desc"} */
  order: {
    score?: "asc" | "desc";
  };
...
export interface PostMangaIdListListIdParamsSchema {
  /**
   * Sort manga relationship entries in ascending order by
   * @min 0
   */
  order?: number;
  /**
...
export interface GetChapterParamsSchema {
  ...
  /**
   * Hostname to filter for in the externalUrl chapter attribute, for example 'mangodex.tld'. Requires accompanying manga filter
   * @pattern ^[a-zA-Z0-9\.\-]{3,64}$
   */
  externalUrl: string;
  /**
   * Hostname to filter out in the externalUrl chapter attribute, for example 'mangodex.tld'. Requires accompanying manga filter
   * @pattern ^[a-zA-Z0-9\.\-]{3,64}$
   */
...
export namespace Manga {
   ...
   * No description
   * @tags Manga
   * @name GetMangaRecommendation
   * @summary Get up to 20 similar Manga Recommendations
   * @request GET:/manga/{id}/recommendation
   */
  export namespace GetMangaRecommendation {
    export type RequestParams = {
      /**
       * Manga ID
       * @format uuid
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = MangaRecommendationListSchema;
  }
